...
OUTPUT_ROOT = PROJECT_ROOT / "AI" / "PlateDetector" / "evaluation" / "val_visual_review_512"
...
CATEGORY_NAMES = [
    "recovered_0175_vs_0275",
    "recovered_0225_vs_0275",
    "persistent_fn_0175",
    "extra_fp_0225_vs_0275",
    "negative_fp",
    "multi_plate_error",
]
...
def main() -> None:
    ...
    for sample in tqdm(cached_predictions):
        ...
        if recovered_recall:
            categories.append("recovered_0175_vs_0275")

        if recovered_balanced:
            categories.append("recovered_0225_vs_0275")
        ...
        if (
            ...
            categories.append("extra_fp_0225_vs_0275")
        ...
        manifest_rows.append(
            {
                ...
                "recovered_gt_0175_vs_0275": "|".join(
                    str(index)
                    for index in sorted(recovered_recall)
                ),
                "recovered_gt_0225_vs_0275": "|".join(
                    str(index)
    ...
    fieldnames = [
        ...
        "f1_fp",
        "f1_fn",
        "recovered_gt_0175_vs_0275",
        "recovered_gt_0225_vs_0275",
        "review_paths",
    ]
